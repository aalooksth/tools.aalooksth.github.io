...
edButtons.push(new edButton('ed_div','div','<div>','</div>'));edButtons.push(new edButton('ed_small','small','<small>','</small>'));edButtons.push(new edButton('ed_h1','H1','<h1>','</h1>','1'));edButtons.push(new edButton('ed_h2','H2','<h2>','</h2>','2'));edButtons.push(new edButton('ed_h3','H3','<h3>','</h3>','3'));edButtons.push(new edButton('ed_h4','H4','<h4>','</h4>','4'));edButtons.push(new edButton('ed_p','P','<p>','</p>','p'));edButtons.push(new edButton('ed_bold','B','<b>','</b>','b'));edButtons.push(new edButton('ed_italic','I','<em>','</em>','i'));edButtons.push(new edButton('ed_link','Link','','</a>','a'));edButtons.push(new edButton('ed_img','IMG','','','m',-1));edButtons.push(new edButton('ed_ul','UL','<ul>','</ul>','u'));edButtons.push(new edButton('ed_ol','OL','<ol>','</ol>','o'));edButtons.push(new edButton('ed_li','LI','<li>','</li>','l'));edButtons.push(new edButton('ed_block','B-QUOTE','<blockquote>','</blockquote>','q'));var extendedStart=edButtons.length;edButtons.push(new edButton('ed_code','CODE','<code>','</code>','c'));edButtons.push(new edButton('ed_pre','PRE','<pre>','</pre>'));edButtons.push(new edButton('ed_dl','DL','<dl>','</dl>'));edButtons.push(new edButton('ed_dt','DT','\t<dt>','</dt>'));edButtons.push(new edButton('ed_dd','DD','\t<dd>','</dd>'));edButtons.push(new edButton('ed_table','TABLE','<table>\n<tbody>','</tbody>\n</table>'));edButtons.push(new edButton('ed_tr','TR','\t<tr>','\n\t</tr>'));edButtons.push(new edButton('ed_td','TD','\t\t<td>','</td>'));edButtons.push(new edButton('ed_footnote','Footnote','','','f'));edButtons.push(new edButton('ed_via','Via','','','v'));function edLink(display,URL,newWin){this.display=display;this.URL=URL;if(!newWin){newWin=0;}
this.newWin=newWin;}
